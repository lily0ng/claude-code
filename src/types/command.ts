...
import type { CompactionResult } from '../services/compact/compact.ts'
...
import type { IDEExtensionInstallationStatus, IdeType } from '../utils/ide.ts'
...
import type { LogOption } from './logs.ts'
