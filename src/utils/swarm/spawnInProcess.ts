...
import { formatAgentId } from '../agentId.ts'
import { registerCleanup } from '../cleanupRegistry.ts'
import { logForDebugging } from '../debug.ts'
import { emitTaskTerminatedSdk } from '../sdkEventQueue.ts'
import { evictTaskOutput } from '../task/diskOutput.ts'
import {
  evictTerminalTask,
  registerTask,
  STOPPED_DISPLAY_MS,
} from '../task/framework.ts'
import { createTeammateContext } from '../teammateContext.ts'
import {
  isPerfettoTracingEnabled,
  registerAgent as registerPerfettoAgent,
  unregisterAgent as unregisterPerfettoAgent,
} from '../telemetry/perfettoTracing.ts'
import { removeMemberByAgentId } from './teamHelpers.ts'
