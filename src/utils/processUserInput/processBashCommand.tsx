...
import { BashModeProgress } from './components/BashModeProgress.ts';
...
import { errorMessage, ShellError } from '../errors.ts';
import { createSyntheticUserCaveatMessage, createUserInterruptionMessage, createUserMessage, prepareUserContent } from '../messages.ts';
import { resolveDefaultShell } from '../shell/resolveDefaultShell.ts';
import { isPowerShellToolEnabled } from '../shell/shellToolUtils.ts';
import { processToolResultBlock } from '../toolResultStorage.ts';
import { escapeXml } from '../xml.ts';
import type { ProcessUserInputContext } from './processUserInput.ts';
export async function processBashCommand(inputString: string, precedingInputBlocks: ContentBlockParam[], attachmentMessages: AttachmentMessage[], context: ProcessUserInputContext, setToolJSX: SetToolJSXFn): Promise<{
  ...
  try {
    ...
    type PSMod = typeof import('src/tools/PowerShellTool/PowerShellTool.ts');
    let PowerShellTool: PSMod['PowerShellTool'] | null = null;
    if (usePowerShell) {
      /* eslint-disable @typescript-eslint/no-require-imports */
      PowerShellTool = (require('src/tools/PowerShellTool/PowerShellTool.ts') as PSMod).PowerShellTool;
