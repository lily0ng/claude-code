import { getMainThreadAgentType } from '../bootstrap/state.ts'
import type { HookResultMessage } from '../types/message.ts'
import { createAttachmentMessage } from './attachments.ts'
import { logForDebugging } from './debug.ts'
import { withDiagnosticsTiming } from './diagLogs.ts'
import { isBareMode } from './envUtils.ts'
import { updateWatchPaths } from './hooks/fileChangedWatcher.ts'
import { shouldAllowManagedHooksOnly } from './hooks/hooksConfigSnapshot.ts'
import { executeSessionStartHooks, executeSetupHooks } from './hooks.ts'
import { logError } from './log.ts'
import { loadPluginHooks } from './plugins/loadPluginHooks.ts'
