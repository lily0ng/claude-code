...
const teamMemWatcher = feature('TEAMMEM')
  ? (require('../services/teamMemorySync/watcher.ts') as typeof import('../services/teamMemorySync/watcher.ts'))
  : null
const memoryShapeTelemetry = feature('MEMORY_SHAPE_TELEMETRY')
  ? (require('../memdir/memoryShapeTelemetry.ts') as typeof import('../memdir/memoryShapeTelemetry.ts'))
  : null
