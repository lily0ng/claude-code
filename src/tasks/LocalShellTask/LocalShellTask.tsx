...
import { OUTPUT_FILE_TAG, STATUS_TAG, SUMMARY_TAG, TASK_ID_TAG, TASK_NOTIFICATION_TAG, TOOL_USE_ID_TAG } from '../../constants/xml.ts';
import { abortSpeculation } from '../../services/PromptSuggestion/speculation.ts';
import type { AppState } from '../../state/AppState.tsx';
import type { LocalShellSpawnInput, SetAppState, Task, TaskContext, TaskHandle } from '../../Task.ts';
...
import type { ShellCommand } from '../../utils/ShellCommand.ts';
import { evictTaskOutput, getTaskOutputPath } from '../../utils/task/diskOutput.ts';
import { registerTask, updateTaskState } from '../../utils/task/framework.ts';
import { escapeXml } from '../../utils/xml.ts';
import { backgroundAgentTask, isLocalAgentTask } from '../LocalAgentTask/LocalAgentTask.tsx';
import { isMainSessionTask } from '../LocalMainSessionTask.ts';
import { type BashTaskKind, isLocalShellTask, type LocalShellTaskState } from './guards.ts';
import { killTask } from './killShellTasks.ts';
