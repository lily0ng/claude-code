...
import { Tab, Tabs } from '../../components/design-system/Tabs.ts';
...
import { AddMarketplace } from './AddMarketplace.ts';
import { BrowseMarketplace } from './BrowseMarketplace.ts';
import { DiscoverPlugins } from './DiscoverPlugins.ts';
import { ManageMarketplaces } from './ManageMarketplaces.ts';
import { ManagePlugins } from './ManagePlugins.ts';
...
import { ValidatePlugin } from './ValidatePlugin.ts';
