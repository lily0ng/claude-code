...
import { notifyCompaction } from '../../services/api/promptCacheBreakDetection.ts'
import {
...
import { suppressCompactWarning } from '../../services/compact/compactWarningState.ts'
...
import { trySessionMemoryCompaction } from '../../services/compact/sessionMemoryCompact.ts'
import { setLastSummarizedMessageId } from '../../services/SessionMemory/sessionMemoryUtils.ts'
...
import { executePreCompactHooks } from '../../utils/hooks.ts'
