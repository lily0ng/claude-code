...
import { getKairosActive, setUserMsgOptIn } from '../bootstrap/state.ts'
...
import { isBriefEntitled } from '../tools/BriefTool/BriefTool.ts'
import { BRIEF_TOOL_NAME } from '../tools/BriefTool/prompt.ts'
import type {
  Command,
