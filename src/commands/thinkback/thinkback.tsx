...
import { enablePluginOp } from '../../services/plugins/pluginOperations.ts';
...
import { isPluginInstalled } from '../../utils/plugins/installedPluginsManager.ts';
import { addMarketplaceSource, clearMarketplacesCache, loadKnownMarketplacesConfig, refreshMarketplace } from '../../utils/plugins/marketplaceManager.ts';
...
export async function playAnimation(skillDir: string): Promise<{
  ...
  const dataPath = join(skillDir, 'year_in_review.ts');
  const playerPath = join(skillDir, 'player.ts');
