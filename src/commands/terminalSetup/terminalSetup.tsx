...
import { backupTerminalPreferences, checkAndRestoreTerminalBackup, getTerminalPlistPath, markTerminalSetupComplete } from '../../utils/appleTerminalBackup.ts';
import { setupShellCompletion } from '../../utils/completionCache.ts';
...
import { addItemToJSONCArray, safeParseJSONC } from '../../utils/json.ts';
