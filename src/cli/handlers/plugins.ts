...
import { setUseCoworkPlugins } from '../../bootstrap/state.ts'
import {
...
import {
  ...
  VALID_UPDATE_SCOPES,
} from '../../services/plugins/pluginCliCommands.ts'
import { getPluginErrorMessage } from '../../types/plugin.ts'
import { errorMessage } from '../../utils/errors.ts'
import { logError } from '../../utils/log.ts'
import { clearAllCaches } from '../../utils/plugins/cacheUtils.ts'
import { getInstallCounts } from '../../utils/plugins/installCounts.ts'
import {
  isPluginInstalled,
  loadInstalledPluginsV2,
} from '../../utils/plugins/installedPluginsManager.ts'
import {
  createPluginId,
  loadMarketplacesWithGracefulDegradation,
} from '../../utils/plugins/marketplaceHelpers.ts'
import {
...
} from '../../utils/plugins/marketplaceManager.ts'
import { loadPluginMcpServers } from '../../utils/plugins/mcpPluginIntegration.ts'
import { parseMarketplaceInput } from '../../utils/plugins/parseMarketplaceInput.ts'
import {
  parsePluginIdentifier,
  scopeToSettingSource,
} from '../../utils/plugins/pluginIdentifier.ts'
import { loadAllPlugins } from '../../utils/plugins/pluginLoader.ts'
import type { PluginSource } from '../../utils/plugins/schemas.ts'
import {
  type ValidationResult,
  validateManifest,
  validatePluginContents,
} from '../../utils/plugins/validatePlugin.ts'
