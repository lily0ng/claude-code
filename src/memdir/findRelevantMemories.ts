...
import { getDefaultSonnetModel } from '../utils/model/model.ts'
import { sideQuery } from '../utils/sideQuery.ts'
...
export async function findRelevantMemories(
  ...
  if (feature('MEMORY_SHAPE_TELEMETRY')) {
    ...
    const { logMemoryRecallShape } =
      require('./memoryShapeTelemetry.ts') as typeof import('./memoryShapeTelemetry.ts')
