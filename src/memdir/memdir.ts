...
import { getAutoMemPath, isAutoMemoryEnabled } from './paths.ts'

/* eslint-disable @typescript-eslint/no-require-imports */
const teamMemPaths = feature('TEAMMEM')
  ? (require('./teamMemPaths.ts') as typeof import('./teamMemPaths.ts'))
  : null

import { getKairosActive, getOriginalCwd } from '../bootstrap/state.ts'
...
const teamMemPrompts = feature('TEAMMEM')
  ? (require('./teamMemPrompts.ts') as typeof import('./teamMemPrompts.ts'))
  : null
/* eslint-enable @typescript-eslint/no-require-imports */
