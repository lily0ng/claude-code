...
import { getBridgeStatus } from '../../bridge/bridgeStatusUtil.ts';
import { useSetPromptOverlay } from '../../context/promptOverlayContext.ts';
...
import { CoordinatorTaskPanel, useCoordinatorTaskCount } from '../CoordinatorAgentStatus.ts';
import { getLastAssistantMessageId, StatusLine, statusLineShouldDisplay } from '../StatusLine.ts';
import { Notifications } from './Notifications.ts';
import { PromptInputFooterLeftSide } from './PromptInputFooterLeftSide.ts';
import { PromptInputFooterSuggestions, type SuggestionItem } from './PromptInputFooterSuggestions.ts';
import { PromptInputHelpMenu } from './PromptInputHelpMenu.ts';
type Props = {
