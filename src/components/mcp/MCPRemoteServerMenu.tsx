...
import { Box, color, Link, Text, useInput, useTheme } from '../../ink.ts';
import { useKeybinding } from '../../keybindings/useKeybinding.ts';
import { AuthenticationCancelledError, performMCPOAuthFlow, revokeServerTokens } from '../../services/mcp/auth.ts';
import { clearServerCache } from '../../services/mcp/client.ts';
import { useMcpReconnect, useMcpToggleEnabled } from '../../services/mcp/MCPConnectionManager.ts';
import { describeMcpConfigFilePath, excludeCommandsByServer, excludeResourcesByServer, excludeToolsByServer, filterMcpPromptsByServer } from '../../services/mcp/utils.ts';
...
import { CapabilitiesSection } from './CapabilitiesSection.ts';
import type { ClaudeAIServerInfo, HTTPServerInfo, SSEServerInfo } from './types.ts';
import { handleReconnectError, handleReconnectResult } from './utils/reconnectHelpers.ts';
type Props = {
