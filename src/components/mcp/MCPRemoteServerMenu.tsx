...
import { useMcpReconnect, useMcpToggleEnabled } from '../../services/mcp/MCPConnectionManager.tsx';
...
import { handleReconnectError, handleReconnectResult } from './utils/reconnectHelpers.tsx';
type Props = {
