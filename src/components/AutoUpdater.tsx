...
import { type AutoUpdaterResult, getLatestVersion, getMaxVersion, type InstallStatus, installGlobalPackage, shouldSkipVersion } from '../utils/autoUpdater.ts';
...
import { installOrUpdateClaudePackage, localInstallationExists } from '../utils/localInstaller.ts';
import { removeInstalledSymlink } from '../utils/nativeInstaller/index.ts';
import { gt, gte } from '../utils/semver.ts';
