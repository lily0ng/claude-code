...
import { getMaxVersion, getMaxVersionMessage } from '../utils/autoUpdater.ts';
import { isAutoUpdaterDisabled } from '../utils/config.ts';
import { installLatest } from '../utils/nativeInstaller/index.ts';
import { gt } from '../utils/semver.ts';
