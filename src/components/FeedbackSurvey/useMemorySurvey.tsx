...
import { isAutoManagedMemoryFile } from '../../utils/memoryFileDetection.ts';
import { extractTextContent, getLastAssistantMessage } from '../../utils/messages.ts';
import { logOTelEvent } from '../../utils/telemetry/events.ts';
import { submitTranscriptShare } from './submitTranscriptShare.ts';
