...
import { deletePermissionRule, getAllowRules, getAskRules, getDenyRules, permissionRuleSourceDisplayString } from '../../../utils/permissions/permissions.ts';
import type { UnreachableRule } from '../../../utils/permissions/shadowedRuleDetection.ts';
import { jsonStringify } from '../../../utils/slowOperations.ts';
import { Pane } from '../../design-system/Pane.ts';
import { Tab, Tabs, useTabHeaderFocus, useTabsWidth } from '../../design-system/Tabs.ts';
import { SearchBox } from '../../SearchBox.ts';
import type { Option } from '../../ui/option.ts';
import { AddPermissionRules } from './AddPermissionRules.ts';
import { AddWorkspaceDirectory } from './AddWorkspaceDirectory.ts';
import { PermissionRuleDescription } from './PermissionRuleDescription.ts';
import { PermissionRuleInput } from './PermissionRuleInput.ts';
import { RecentDenialsTab } from './RecentDenialsTab.ts';
import { RemoveWorkspaceDirectory } from './RemoveWorkspaceDirectory.ts';
import { WorkspaceTab } from './WorkspaceTab.ts';
