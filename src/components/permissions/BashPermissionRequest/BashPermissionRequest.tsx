...
import { getFirstWordPrefix, getSimpleCommandPrefix } from '../../../tools/BashTool/bashPermissions.ts';
import { getDestructiveCommandWarning } from '../../../tools/BashTool/destructiveCommandWarning.ts';
import { parseSedEditCommand } from '../../../tools/BashTool/sedEditParser.ts';
import { shouldUseSandbox } from '../../../tools/BashTool/shouldUseSandbox.ts';
import { getCompoundCommandPrefixesStatic } from '../../../utils/bash/prefix.ts';
import { createPromptRuleContent, generateGenericDescription, getBashPromptAllowDescriptions, isClassifierPermissionsEnabled } from '../../../utils/permissions/bashClassifier.ts';
...
import { SedEditPermissionRequest } from '../SedEditPermissionRequest/SedEditPermissionRequest.tsx';
import { useShellPermissionFeedback } from '../useShellPermissionFeedback.ts';
import { logUnaryPermissionEvent } from '../utils.ts';
import { bashToolUseOptions } from './bashToolUseOptions.tsx';
