...
import type { Question, QuestionOption } from '../../../tools/AskUserQuestionTool/AskUserQuestionTool.ts';
...
import { type OptionWithDescription, Select, SelectMulti } from '../../CustomSelect/index.ts';
...
import { PreviewQuestionView } from './PreviewQuestionView.ts';
import { QuestionNavigationBar } from './QuestionNavigationBar.ts';
import type { QuestionState } from './use-multiple-choice-state.ts';
type Props = {
  question: Question;
  questions: Question[];
