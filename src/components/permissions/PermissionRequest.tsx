...
const ReviewArtifactPermissionRequest = feature('REVIEW_ARTIFACT') ? (require('./ReviewArtifactPermissionRequest/ReviewArtifactPermissionRequest.ts') as typeof import('./ReviewArtifactPermissionRequest/ReviewArtifactPermissionRequest.ts')).ReviewArtifactPermissionRequest : null;
const WorkflowTool = feature('WORKFLOW_SCRIPTS') ? (require('../../tools/WorkflowTool/WorkflowTool.ts') as typeof import('../../tools/WorkflowTool/WorkflowTool.ts')).WorkflowTool : null;
const WorkflowPermissionRequest = feature('WORKFLOW_SCRIPTS') ? (require('../../tools/WorkflowTool/WorkflowPermissionRequest.ts') as typeof import('../../tools/WorkflowTool/WorkflowPermissionRequest.ts')).WorkflowPermissionRequest : null;
const MonitorTool = feature('MONITOR_TOOL') ? (require('../../tools/MonitorTool/MonitorTool.ts') as typeof import('../../tools/MonitorTool/MonitorTool.ts')).MonitorTool : null;
const MonitorPermissionRequest = feature('MONITOR_TOOL') ? (require('./MonitorPermissionRequest/MonitorPermissionRequest.ts') as typeof import('./MonitorPermissionRequest/MonitorPermissionRequest.ts')).MonitorPermissionRequest : null;
