...
import type { Message as MessageType, NormalizedMessage, ProgressMessage as ProgressMessageType, RenderableMessage } from '../types/message.ts';
import { type AdvisorBlock, isAdvisorBlock } from '../utils/advisor.ts';
import { collapseBackgroundBashNotifications } from '../utils/collapseBackgroundBashNotifications.ts';
import { collapseHookSummaries } from '../utils/collapseHookSummaries.ts';
import { collapseReadSearchGroups } from '../utils/collapseReadSearch.ts';
import { collapseTeammateShutdowns } from '../utils/collapseTeammateShutdowns.ts';
...
import { applyGrouping } from '../utils/groupToolUses.ts';
...
const BRIEF_TOOL_NAME: string | null = feature('KAIROS') || feature('KAIROS_BRIEF') ? (require('../tools/BriefTool/prompt.ts') as typeof import('../tools/BriefTool/prompt.ts')).BRIEF_TOOL_NAME : null;
...
type Props = {
  ...
  scanElement?: (el: import('../ink/dom.ts').DOMElement) => import('../ink/render-to-screen.ts').MatchPosition[];
  /** Position-based CURRENT highlight. positions stable (msg-relative),
   *  rowOffset tracks scroll. null clears. */
  setPositions?: (state: {
    positions: import('../ink/render-to-screen.ts').MatchPosition[];
    rowOffset: number;
    currentIdx: number;
  } | null) => void;
