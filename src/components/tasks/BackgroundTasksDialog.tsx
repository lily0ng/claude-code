...
import { InProcessTeammateTask } from './tasks/InProcessTeammateTask/InProcessTeammateTask.ts';
...
import { RemoteAgentTask, type RemoteAgentTaskState } from './tasks/RemoteAgentTask/RemoteAgentTask.ts';
...
const WorkflowDetailDialog = feature('WORKFLOW_SCRIPTS') ? (require('./WorkflowDetailDialog.ts') as typeof import('./WorkflowDetailDialog.ts')).WorkflowDetailDialog : null;
const workflowTaskModule = feature('WORKFLOW_SCRIPTS') ? require('src/tasks/LocalWorkflowTask/LocalWorkflowTask.ts') as typeof import('src/tasks/LocalWorkflowTask/LocalWorkflowTask.ts') : null;
...
const monitorMcpModule = feature('MONITOR_TOOL') ? require('../../tasks/MonitorMcpTask/MonitorMcpTask.ts') as typeof import('../../tasks/MonitorMcpTask/MonitorMcpTask.ts') : null;
const killMonitorMcp = monitorMcpModule?.killMonitorMcp ?? null;
const MonitorMcpDetailDialog = feature('MONITOR_TOOL') ? (require('./MonitorMcpDetailDialog.ts') as typeof import('./MonitorMcpDetailDialog.ts')).MonitorMcpDetailDialog : null;
