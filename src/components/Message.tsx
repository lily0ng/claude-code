...
import type { AssistantMessage, AttachmentMessage as AttachmentMessageType, CollapsedReadSearchGroup as CollapsedReadSearchGroupType, GroupedToolUseMessage as GroupedToolUseMessageType, NormalizedUserMessage, ProgressMessage, SystemMessage } from '../types/message.ts';
import { type AdvisorBlock, isAdvisorBlock } from '../utils/advisor.ts';
import { isFullscreenEnvEnabled } from '../utils/fullscreen.ts';
import { logError } from '../utils/log.ts';
import type { buildMessageLookups } from '../utils/messages.ts';
import { CompactSummary } from './CompactSummary.ts';
import { AdvisorMessage } from './messages/AdvisorMessage.ts';
import { AssistantRedactedThinkingMessage } from './messages/AssistantRedactedThinkingMessage.ts';
import { AssistantTextMessage } from './messages/AssistantTextMessage.ts';
import { AssistantThinkingMessage } from './messages/AssistantThinkingMessage.ts';
import { AssistantToolUseMessage } from './messages/AssistantToolUseMessage.ts';
import { AttachmentMessage } from './messages/AttachmentMessage.ts';
import { CollapsedReadSearchContent } from './messages/CollapsedReadSearchContent.ts';
import { CompactBoundaryMessage } from './messages/CompactBoundaryMessage.ts';
import { GroupedToolUseContent } from './messages/GroupedToolUseContent.ts';
import { SystemTextMessage } from './messages/SystemTextMessage.ts';
import { UserImageMessage } from './messages/UserImageMessage.ts';
import { UserTextMessage } from './messages/UserTextMessage.ts';
import { UserToolResultMessage } from './messages/UserToolResultMessage/UserToolResultMessage.ts';
import { OffscreenFreeze } from './OffscreenFreeze.ts';
import { ExpandShellOutputProvider } from './shell/ExpandShellOutputContext.ts';
export type Props = {
    ...
    case "system":
      {
        ...
        if (feature("HISTORY_SNIP")) {
          ...
          } = require("../services/compact/snipProjection.js") as typeof import('../services/compact/snipProjection.ts');
          const {
            isSnipMarkerMessage
          } = require("../services/compact/snipCompact.js") as typeof import('../services/compact/snipCompact.ts');
          if (isSnipBoundaryMessage(message)) {
            ...
            const {
              SnipBoundaryMessage
            } = t2 as typeof import('./messages/SnipBoundaryMessage.ts');
            let t3;
            if ($[66] !== message) {
