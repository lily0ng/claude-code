...
import { getSystemThemeName, type SystemTheme } from '../../utils/systemTheme.ts';
import type { ThemeName, ThemeSetting } from '../../utils/theme.ts';
...
export function ThemeProvider({
  ...
  useEffect(() => {
    if (feature('AUTO_THEME')) {
      ...
      let cancelled = false;
      void import('../../utils/systemThemeWatcher.ts').then(({
        watchSystemTheme
      }) => {
        if (cancelled) return;
