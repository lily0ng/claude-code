...
const sessionTranscriptModule = feature('KAIROS')
  ? (require('../sessionTranscript/sessionTranscript.ts') as typeof import('../sessionTranscript/sessionTranscript.ts'))
  : null
...
import { logPermissionContextForAnts } from '../internalLogging.ts'
import {
