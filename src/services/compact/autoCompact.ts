...
import { getMaxOutputTokensForModel } from '../api/claude.ts'
import { notifyCompaction } from '../api/promptCacheBreakDetection.ts'
import { setLastSummarizedMessageId } from '../SessionMemory/sessionMemoryUtils.ts'
import {
...
import { runPostCompactCleanup } from './postCompactCleanup.ts'
import { trySessionMemoryCompaction } from './sessionMemoryCompact.ts'
...
export async function shouldAutoCompact(
  ...
  if (feature('CONTEXT_COLLAPSE')) {
    ...
    const { isContextCollapseEnabled } =
      require('../contextCollapse/index.ts') as typeof import('../contextCollapse/index.ts')
