...
} from '@modelcontextprotocol/sdk/server/auth/errors.ts'
import {
...
import xss from 'xss'
import { MCP_CLIENT_METADATA_URL } from '../../constants/oauth.ts'
import { openBrowser } from '../../utils/browser.ts'
import { getClaudeConfigHomeDir } from '../../utils/envUtils.ts'
import { errorMessage, getErrnoCode } from '../../utils/errors.ts'
import * as lockfile from '../../utils/lockfile.ts'
...
import type { SecureStorageData } from '../../utils/secureStorage/types.ts'
import { sleep } from '../../utils/sleep.ts'
import { jsonParse, jsonStringify } from '../../utils/slowOperations.ts'
import { logEvent } from '../analytics/index.ts'
import type { AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS } from '../analytics/metadata.ts'
import { buildRedirectUri, findAvailablePort } from './oauthPort.ts'
import type { McpHTTPServerConfig, McpSSEServerConfig } from './types.ts'
import { getLoggingSafeMcpBaseUrl } from './utils.ts'
import { performCrossAppAccess, XaaTokenExchangeError } from './xaa.ts'
import {
  acquireIdpIdToken,
  clearIdpIdToken,
  discoverOidc,
