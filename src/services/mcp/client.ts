...
} from '@modelcontextprotocol/sdk/client/streamableHttp.ts'
import {
  createFetchWithInit,
  type FetchLike,
  type Transport,
} from '@modelcontextprotocol/sdk/shared/transport.ts'
import {
...
import { UnauthorizedError } from '@modelcontextprotocol/sdk/client/auth.ts'
...
const isComputerUseMCPServer = feature('CHICAGO_MCP')
  ? (
      require('../../utils/computerUse/common.ts') as typeof import('../../utils/computerUse/common.ts')
