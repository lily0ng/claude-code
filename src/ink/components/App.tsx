...
import { updateLastInteractionTime } from '../../bootstrap/state.ts';
import { logForDebugging } from '../../utils/debug.ts';
import { stopCapturingEarlyInput } from '../../utils/earlyInput.ts';
import { isEnvTruthy } from '../../utils/envUtils.ts';
import { isMouseClicksDisabled } from '../../utils/fullscreen.ts';
...
import { INITIAL_STATE, type ParsedInput, type ParsedKey, type ParsedMouse, parseMultipleKeypresses } from '../parse-keypress.ts';
import reconciler from '../reconciler.ts';
import { finishSelection, hasSelection, type SelectionState, startSelection } from '../selection.ts';
import { isXtermJs, setXtversionName, supportsExtendedKeys } from '../terminal.ts';
import { getTerminalFocused, setTerminalFocused } from '../terminal-focus-state.ts';
import { TerminalQuerier, xtversion } from '../terminal-querier.ts';
