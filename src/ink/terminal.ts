...
import { getClearTerminalSequence } from './clearTerminal.ts'
import type { Diff } from './frame.ts'
import { cursorMove, cursorTo, eraseLines } from './termio/csi.ts'
import { BSU, ESU, HIDE_CURSOR, SHOW_CURSOR } from './termio/dec.ts'
import { link } from './termio/osc.ts'
...
export function isXtermJs(): boolean {
  ...
  return xtversionName?.startsWith('xterm.ts') ?? false
}
