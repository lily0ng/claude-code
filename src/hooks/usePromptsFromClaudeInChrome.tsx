...
import type { ConnectedMCPServer, MCPServerConnection } from '../services/mcp/types.ts';
import type { PermissionMode } from '../types/permissions.ts';
import { CLAUDE_IN_CHROME_MCP_SERVER_NAME, isTrackedClaudeInChromeTabId } from '../utils/claudeInChrome/common.ts';
