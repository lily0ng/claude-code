...
import type { ToolPermissionContext, Tool as ToolType, ToolUseContext } from '../Tool.ts';
import { consumeSpeculativeClassifierCheck, peekSpeculativeClassifierCheck } from '../tools/BashTool/bashPermissions.ts';
import { BASH_TOOL_NAME } from '../tools/BashTool/toolName.ts';
import type { AssistantMessage } from '../types/message.ts';
import { recordAutoModeDenial } from '../utils/autoModeDenials.ts';
import { clearClassifierChecking, setClassifierApproval, setYoloClassifierApproval } from '../utils/classifierApprovals.ts';
...
import { handleCoordinatorPermission } from './toolPermission/handlers/coordinatorHandler.ts';
import { handleInteractivePermission } from './toolPermission/handlers/interactiveHandler.ts';
import { handleSwarmWorkerPermission } from './toolPermission/handlers/swarmWorkerHandler.ts';
import { createPermissionContext, createPermissionQueueOps } from './toolPermission/PermissionContext.ts';
import { logPermissionDecision } from './toolPermission/permissionLogging.ts';
