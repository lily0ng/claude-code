...
import { KeybindingWarnings } from './components/KeybindingWarnings.ts';
import { McpParsingWarnings } from './components/mcp/McpParsingWarnings.ts';
...
import { PressEnterToContinue } from '../components/PressEnterToContinue.ts';
import { SandboxDoctorSection } from '../components/sandbox/SandboxDoctorSection.ts';
import { ValidationErrorsList } from '../components/ValidationErrorsList.ts';
...
import { getGcsDistTags, getNpmDistTags, type NpmDistTags } from '../utils/autoUpdater.ts';
import { type ContextWarnings, checkContextWarnings } from '../utils/doctorContextWarnings.ts';
import { type DiagnosticInfo, getDoctorDiagnostic } from '../utils/doctorDiagnostic.ts';
import { validateBoundedIntEnvVar } from '../utils/envValidation.ts';
import { pathExists } from '../utils/file.ts';
import { cleanupStaleLocks, getAllLockInfo, isPidBasedLockingEnabled, type LockInfo } from '../utils/nativeInstaller/pidLock.ts';
import { getInitialSettings } from '../utils/settings/settings.ts';
import { BASH_MAX_OUTPUT_DEFAULT, BASH_MAX_OUTPUT_UPPER_LIMIT } from '../utils/shell/outputLimits.ts';
import { TASK_MAX_OUTPUT_DEFAULT, TASK_MAX_OUTPUT_UPPER_LIMIT } from '../utils/task/outputFormatting.ts';
import { getXDGStateHome } from '../utils/xdg.ts';
type Props = {
