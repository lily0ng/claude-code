...
import { getSlashCommandToolSkills } from './commands.ts'
import {
...
import { countToolCalls, SYNTHETIC_MESSAGES } from './utils/messages.ts'
import {
  getMainLoopModel,
...
const messageSelector =
  (): typeof import('src/components/MessageSelector.ts') =>
    require('src/components/MessageSelector.ts')
...
const getCoordinatorUserContext: (
  ...
  ? require('./coordinator/coordinatorMode.ts').getCoordinatorUserContext
  : () => ({})
/* eslint-enable @typescript-eslint/no-require-imports */
